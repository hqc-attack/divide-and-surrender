...
RUN apt-get update -y && DEBIAN_FRONTEND=noninteractive TZ=Etc/UTC apt-get install -y curl msr-tools python3 python3-venv python3-pip m4 build-essential clang cmake libssl-dev texlive-full vim git && apt-get clean -y
