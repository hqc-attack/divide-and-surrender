...
OQS_API const char *OQS_KEM_alg_identifier(size_t i) {
	...
	const char *a[OQS_KEM_algs_length] = {
		...
		OQS_KEM_alg_hqc_192,
		OQS_KEM_alg_hqc_256,
		OQS_KEM_alg_hqc_r4_128,
		OQS_KEM_alg_hqc_r4_192,
		OQS_KEM_alg_hqc_r4_256,
...
OQS_API int OQS_KEM_alg_is_enabled(const char *method_name) {
	if (method_name == NULL) {
		...
		return 0;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_hqc_r4_128)) {
#ifdef OQS_ENABLE_KEM_hqc_r4_128
		return 1;
#else
		return 0;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_hqc_r4_192)) {
#ifdef OQS_ENABLE_KEM_hqc_r4_192
		return 1;
#else
		return 0;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_hqc_r4_256)) {
...
#ifdef OQS_ENABLE_KEM_hqc_r4_128
		return OQS_KEM_hqc_r4_128_new();
#else
		return NULL;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_hqc_r4_192)) {
#ifdef OQS_ENABLE_KEM_hqc_r4_192
		return OQS_KEM_hqc_r4_192_new();
#else
		return NULL;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_hqc_r4_256)) {
#ifdef OQS_ENABLE_KEM_hqc_r4_256
		return OQS_KEM_hqc_r4_256_new();
#else
		return NULL;
#endif
	} else if (0 == strcasecmp(method_name, OQS_KEM_alg_kyber_512)) {
