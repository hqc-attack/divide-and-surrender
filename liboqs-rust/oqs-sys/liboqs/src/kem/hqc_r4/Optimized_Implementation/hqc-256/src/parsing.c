 ...
 */
void HQC_R4_256_AVX2_hqc_secret_key_to_string(uint8_t *sk, const uint8_t *sk_seed, const uint8_t *sigma, const uint8_t *pk) {
 ...
 */
void HQC_R4_256_AVX2_hqc_secret_key_from_string(__m256i *x256, __m256i *y256, uint8_t *sigma, uint8_t *pk, const uint8_t *sk) {
    ...
    HQC_R4_256_AVX2_vect_set_random_fixed_weight(&sk_seedexpander, x256, PARAM_OMEGA);
    HQC_R4_256_AVX2_vect_set_random_fixed_weight(&sk_seedexpander, y256, PARAM_OMEGA);
 ...
 */
void HQC_R4_256_AVX2_hqc_public_key_to_string(uint8_t *pk, const uint8_t *pk_seed, const uint64_t *s) {
 ...
 * @param[in] pk String containing the public key
 */
void HQC_R4_256_AVX2_hqc_public_key_from_string(uint64_t *h, uint64_t *s, const uint8_t *pk) {
    ...
    HQC_R4_256_AVX2_vect_set_random(&pk_seedexpander, h);
 ...
 */
void HQC_R4_256_AVX2_hqc_ciphertext_to_string(uint8_t *ct, const uint64_t *u, const uint64_t *v, const uint64_t *salt) {
 ...
 */
void HQC_R4_256_AVX2_hqc_ciphertext_from_string(uint64_t *u, uint64_t *v, uint64_t *salt, const uint8_t *ct) {
