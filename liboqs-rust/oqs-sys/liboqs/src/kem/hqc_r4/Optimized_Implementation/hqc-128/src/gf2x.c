...
static inline void HQC_R4_128_AVX2_reduce(__m256i *o, const __m256i *a);
static inline void HQC_R4_128_AVX2_karat_mult_1(__m128i *C, __m128i *A, __m128i *B);
static inline void HQC_R4_128_AVX2_karat_mult_2(__m256i *C, __m256i *A, __m256i *B);
static inline void HQC_R4_128_AVX2_karat_mult_4(__m256i *C, __m256i *A, __m256i *B);
static inline void HQC_R4_128_AVX2_karat_mult_8(__m256i *C, __m256i *A, __m256i *B);
static inline void HQC_R4_128_AVX2_karat_mult3(__m256i *C, __m256i *A, __m256i *B);
static inline void HQC_R4_128_AVX2_divide_by_x_plus_one_256(__m256i *out, __m256i *in, int32_t size);
static inline void HQC_R4_128_AVX2_toom_3_mult(__m256i *C, const __m256i *A, const __m256i *B);
 ...
 */
static inline void HQC_R4_128_AVX2_reduce(__m256i *o, const __m256i *a256) {
...
static inline void HQC_R4_128_AVX2_karat_mult_2(__m256i *C, __m256i *A, __m256i *B) {
	...
	HQC_R4_128_AVX2_karat_mult_1((__m128i *) D0, A128, B128);
	HQC_R4_128_AVX2_karat_mult_1((__m128i *) D2, A128 + 2, B128 + 2);

	SAA = _mm256_xor_si256(A[0], A[1]);
	SBB = _mm256_xor_si256(B[0], B[1]);

	HQC_R4_128_AVX2_karat_mult_1((__m128i *) D1,(__m128i *) &SAA,(__m128i *) &SBB);
...
static inline void HQC_R4_128_AVX2_karat_mult_4(__m256i *C, __m256i *A, __m256i *B) {
	...
	HQC_R4_128_AVX2_karat_mult_2(D0, A, B);
	HQC_R4_128_AVX2_karat_mult_2(D2, A + 2, B + 2);
	...
	HQC_R4_128_AVX2_karat_mult_2( D1, SAA, SBB);
...
static inline void HQC_R4_128_AVX2_karat_mult_8(__m256i *C, __m256i *A, __m256i *B) {
	...
	HQC_R4_128_AVX2_karat_mult_4(D0, A, B);
	HQC_R4_128_AVX2_karat_mult_4(D2, A + 4, B + 4);
	...
	HQC_R4_128_AVX2_karat_mult_4(D1, SAA, SBB);
 ...
 * @param[in] B Pointer to the polynomial B(x)
 */
static inline void HQC_R4_128_AVX2_karat_mult3(__m256i *Out, __m256i *A, __m256i *B) {
	...
	HQC_R4_128_AVX2_karat_mult_8(D0, a0, b0);
	HQC_R4_128_AVX2_karat_mult_8(D1, a1, b1);
	HQC_R4_128_AVX2_karat_mult_8(D2, a2, b2);

	HQC_R4_128_AVX2_karat_mult_8(D3, aa01, bb01);
	HQC_R4_128_AVX2_karat_mult_8(D4, aa02, bb02);
	HQC_R4_128_AVX2_karat_mult_8(D5, aa12, bb12);
 ...
 * @param[in] B Pointer to the polynomial B(x)
 */
void HQC_R4_128_AVX2_toom_3_mult(__m256i *Out, const __m256i *A256, const __m256i *B256) {
	__m256i U0[T_TM3R_3W_256], V0[T_TM3R_3W_256], U1[T_TM3R_3W_256], V1[T_TM3R_3W_256], U2[T_TM3R_3W_256], V2[T_TM3R_3W_256];
	__m256i W0[2 * (T_TM3R_3W_256)], W1[2 * (T_TM3R_3W_256)], W2[2 * (T_TM3R_3W_256)], W3[2 * (T_TM3R_3W_256)], W4[2 * (T_TM3R_3W_256)];
	__m256i tmp[4 * (T_TM3R_3W_256)];
	__m256i ro256[6 * (T_TM3R_3W_256)];
	...
	//W1 = W2 * W3
	HQC_R4_128_AVX2_karat_mult3(W1, W2, W3);
	...
	//W3 = W3 * W2; W2 = W0 * W4
	HQC_R4_128_AVX2_karat_mult3(tmp, W3, W2);
	for(int32_t i = 0; i < 2 * (T_TM3R_3W_256); i++) {
		W3[i] = tmp[i];
	}
	
	HQC_R4_128_AVX2_karat_mult3(W2, W0, W4);

	//W4 = U2 * V2; W0 = U0 * V0
	HQC_R4_128_AVX2_karat_mult3(W4, U2, V2);
	HQC_R4_128_AVX2_karat_mult3(W0, U0, V0);
	...
	HQC_R4_128_AVX2_divide_by_x_plus_one_256(W2, tmp, T_TM3R_3W_256);
	...
	HQC_R4_128_AVX2_divide_by_x_plus_one_256(W3, tmp, T_TM3R_3W_256);
 ...
 */
void HQC_R4_128_AVX2_vect_mul(__m256i *o, const __m256i *a1, const __m256i *a2) {
	__m256i a1_times_a2[VEC_N_256_SIZE_64 >> 1];
    HQC_R4_128_AVX2_toom_3_mult(a1_times_a2, a1, a2);
    HQC_R4_128_AVX2_reduce(o, a1_times_a2);
