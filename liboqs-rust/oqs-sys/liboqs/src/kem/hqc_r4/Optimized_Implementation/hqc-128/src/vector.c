 ...
 * @param[in] ctx Pointer to the context of the seed expander
 */
void HQC_R4_128_AVX2_vect_set_random(seedexpander_state *ctx, uint64_t *v) {
    uint8_t rand_bytes[VEC_N_SIZE_BYTES] = {0};

    HQC_R4_128_AVX2_seedexpander(ctx, rand_bytes, VEC_N_SIZE_BYTES);
 ...
 */
void HQC_R4_128_AVX2_vect_set_random_from_prng(uint64_t *v, uint32_t size_v) {
    uint8_t rand_bytes [32] = {0}; // set to the maximum possible size - 256 bits

    HQC_R4_128_AVX2_shake_prng(rand_bytes, size_v << 3);
 ...
 */
void HQC_R4_128_AVX2_vect_add(uint64_t *o, const uint64_t *v1, const uint64_t *v2, uint32_t size) {
 ...
 */
uint8_t HQC_R4_128_AVX2_vect_compare(const uint8_t *v1, const uint8_t *v2, uint32_t size) {
    uint64_t r = 0;
 ...
 */
void HQC_R4_128_AVX2_vect_resize(uint64_t *o, uint32_t size_o, const uint64_t *v, uint32_t size_v) {
 ...
 */
void HQC_R4_128_AVX2_vect_print(const uint64_t *v, const uint32_t size) {
 ...
 */
void HQC_R4_128_AVX2_vect_print_sparse(const uint32_t *v, const uint16_t weight) {
