...
void PQCLEAN_HQCRMRS128_AVX2_hqc_pke_encrypt_chosen_inputs(uint64_t *u, uint64_t *v, uint8_t *m, unsigned char *theta, const unsigned char *pk, const unsigned char *r2I, const unsigned char *eI) {
    AES_XOF_struct seedexpander;
    aligned_vec_t vh = {0};
    uint64_t *h = vh.arr64;
    aligned_vec_t vs = {0};
    ...
    // Compute u = r1 + r2.h
    // PQCLEAN_HQCRMRS128_AVX2_vect_mul(u, &vr2, &vh);
    // PQCLEAN_HQCRMRS128_AVX2_vect_add(u, r1, tmp1, VEC_N_256_SIZE_64);
