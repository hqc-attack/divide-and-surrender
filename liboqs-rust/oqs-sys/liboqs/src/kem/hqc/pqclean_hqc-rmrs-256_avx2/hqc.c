...
void PQCLEAN_HQCRMRS256_AVX2_hqc_pke_encrypt_chosen_inputs(uint64_t *u, uint64_t *v, uint8_t *m, unsigned char *theta, const unsigned char *pk, const unsigned char *r2I, const unsigned char *eI) {
    AES_XOF_struct seedexpander;
    aligned_vec_t vh = {0};
    uint64_t *h = vh.arr64;
    aligned_vec_t vs = {0};
    ...
    aligned_vec_t vr2 = {0};
    uint64_t *r2 = vr2.arr64;
    memcpy(r2, r2I, VEC_N_SIZE_BYTES);
    aligned_vec_t ve = {0};
    uint64_t *e = ve.arr64;
    memcpy(e, eI, VEC_N_SIZE_BYTES);
    aligned_vec_t vtmp1 = {0};
    uint64_t *tmp1 = vtmp1.arr64;
    aligned_vec_t vtmp2 = {0};
    uint64_t *tmp2 = vtmp2.arr64;
    ...
    // Compute u = r1 + r2.h
    // PQCLEAN_HQCRMRS256_AVX2_vect_mul(u, &vr2, &vh);
    // PQCLEAN_HQCRMRS256_AVX2_vect_add(u, r1, tmp1, VEC_N_256_SIZE_64);
