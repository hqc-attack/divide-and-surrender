...
# ╔═╡ a46fcb04-a746-49a9-bbf2-d5666cc2400e
using CSV, DataFrames, Plots, PGFPlotsX

# ╔═╡ ce39892b-fe85-4b2d-bc22-569890a1d882
df = CSV.File("data/trace_56.csv") |> DataFrame

# ╔═╡ b04fc704-230e-48d4-9bd7-035b977a83db
expand_trace(trace) = vcat([[x for _ in 1:x] for x in trace]...)

# ╔═╡ e71c375d-3d5e-4ede-9805-3ae930fd107b
plot(expand_trace(df.cycles), xlab="time (cycles)", ylab="cycle delta")

# ╔═╡ 690844da-4157-4ece-8583-378305a5f1a0
sum(df.cycles[df.cycles .> 100])

# ╔═╡ 4a92ef2b-7170-4c4e-acbf-5a0da084fe3e
sum(df.cycles)
...
manifest_format = "2.0"
project_hash = "ca083c0a568c2933081e9715f76a8673f51050d0"
