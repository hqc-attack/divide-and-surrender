...
println("A median of $(median(df.traces)) DIV-SMT traces were used to form responses to a median of $(median(df.queries)) oracle calls in a median attack runtime of $(median(df.duration_seconds)).")
